    ...
    public static class FilesFolders
    {
        ...
        public static List<string> GetAllDDBandTDBFilesInFoldersAndSubfolders(string startFolder, List<string> foundFiles)
        {
            ...
            try
            {
                ...
                {
                    foundFiles.AddRange(System.IO.Directory.GetFiles(startFolder, TDBpattern, SearchOption.TopDirectoryOnly));
                    foundFiles.AddRange(System.IO.Directory.GetFiles(startFolder, DDBpattern, SearchOption.TopDirectoryOnly));
                    foreach (string directory in Directory.GetDirectories(startFolder))
                    {
                        GetAllDDBandTDBFilesInFoldersAndSubfolders(directory, foundFiles);
                    }
                }
            }
            catch (System.Exception)
