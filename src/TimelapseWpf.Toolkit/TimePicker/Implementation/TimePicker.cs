...
namespace TimelapseWpf.Toolkit
{
  ...
  public class TimePicker : DateTimePickerBase
  {
    ...
    public static readonly DependencyProperty EndTimeProperty = DependencyProperty.Register( nameof(EndTime), typeof( TimeSpan ), typeof( TimePicker ), new UIPropertyMetadata( EndTimeDefaultValue, OnEndTimeChanged, OnCoerceEndTime ) );
    ...
    public static readonly DependencyProperty MaxDropDownHeightProperty = DependencyProperty.Register( nameof(MaxDropDownHeight), typeof( double ), typeof( TimePicker ), new UIPropertyMetadata( 130d, OnMaxDropDownHeightChanged ) );
    ...
    public static readonly DependencyProperty StartTimeProperty = DependencyProperty.Register( nameof(StartTime), typeof( TimeSpan ), typeof( TimePicker ), new UIPropertyMetadata( StartTimeDefaultValue, OnStartTimeChanged, OnCoerceStartTime ) );
    ...
    public static readonly DependencyProperty TimeIntervalProperty = DependencyProperty.Register( nameof(TimeInterval), typeof( TimeSpan ), typeof( TimePicker ), new UIPropertyMetadata( TimeIntervalDefaultValue, OnTimeIntervalChanged ) );
    ...
    protected override void OnValueChanged( DateTime? oldValue, DateTime? newValue )
    {
      ...
      bool invalidate = DateTimeUtilities.IsSameDate( this.Minimum, oldValue )
        != DateTimeUtilities.IsSameDate( this.Minimum, newValue ) || DateTimeUtilities.IsSameDate( this.Maximum, oldValue )
        != DateTimeUtilities.IsSameDate( this.Maximum, newValue ) || oldValue.GetValueOrDefault().Date != newValue.GetValueOrDefault().Date;
    ...
    protected override void Popup_Opened( object sender, EventArgs e )
    {
      ...
      if( _timeListBox != null )
      {
        ...
        var time = this.Value?.TimeOfDay ?? TimePicker.StartTimeDefaultValue;
    ...
    private void TimeListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
      ...
      {
        if (e.AddedItems[0] is not TimeItem selectedTimeListItem)
          return;
    ...
    protected virtual TimeItem CreateTimeItem( TimeSpan time )
    {
      ...
      return new( date.Date.Add( time ).ToString( formatString, CultureInfo ), time );
    }
    ...
    private TimeItem GetNearestTimeItem( TimeSpan time )
    {
      if( _timeListBox != null )
      {
        ...
        {
          if( _timeListBox.Items[ i ] is TimeItem timeItem )
          {
