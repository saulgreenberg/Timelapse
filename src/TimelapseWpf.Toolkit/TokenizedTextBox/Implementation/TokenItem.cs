...
namespace TimelapseWpf.Toolkit
{
  public class TokenItem : ContentControl
  {
    ...
    public static readonly DependencyProperty TokenKeyProperty = DependencyProperty.Register( nameof(TokenKey), typeof( string ), typeof( TokenItem ), new UIPropertyMetadata( null ) );
    public string TokenKey
    {
      get => ( string )GetValue( TokenKeyProperty );
