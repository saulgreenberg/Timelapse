...
namespace TimelapseWpf.Toolkit
{
  public class AutoSelectTextBox : TextBox
  {
    ...
    public static readonly DependencyProperty AutoSelectBehaviorProperty =
        DependencyProperty.Register( nameof(AutoSelectBehavior), typeof( AutoSelectBehavior ), typeof( AutoSelectTextBox ),
    ...
    public static readonly DependencyProperty AutoMoveFocusProperty =
        DependencyProperty.Register( nameof(AutoMoveFocus), typeof( bool ), typeof( AutoSelectTextBox ), new UIPropertyMetadata( false ) );
    ...
    {
      QueryMoveFocusEventArgs e = new( direction, reachedMax );
      this.RaiseEvent( e );
    ...
    private bool MoveFocusLeft()
    {
      if( this.FlowDirection == FlowDirection.LeftToRight )
      {
        ...
        if( ( this.CaretIndex == 0 ) && ( this.SelectionLength == 0 ) )
        {
          ...
          {
            this.MoveFocus( new( FocusNavigationDirection.Left ) );
            return true;
          }
        }
      }
    ...
    private bool MoveFocusRight()
    {
      if( this.FlowDirection == FlowDirection.LeftToRight )
      {
        ...
        if( ( this.CaretIndex == this.Text.Length ) && ( this.SelectionLength == 0 ) )
        {
          ...
          {
            this.MoveFocus( new( FocusNavigationDirection.Right ) );
            return true;
          }
        }
      }
    ...
    private bool MoveFocusUp()
    {
      ...
      if( lineNumber == 0 )
      {
        ...
        {
          this.MoveFocus( new( FocusNavigationDirection.Up ) );
          return true;
        }
      }
    ...
    private bool MoveFocusDown()
    {
      ...
      if( lineNumber == ( this.LineCount - 1 ) )
      {
        ...
        {
          this.MoveFocus( new( FocusNavigationDirection.Down ) );
          return true;
        }
      }
