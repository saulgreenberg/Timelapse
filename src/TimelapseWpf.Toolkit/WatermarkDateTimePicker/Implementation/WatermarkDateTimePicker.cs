...
{
  /// <summary>
  /// DateTimePicker with enhanced watermark support including ForceWatermark and HideOnFocus properties.
  /// Inherits Watermark and WatermarkTemplate properties from DateTimePicker base class.
  /// </summary>
  public class WatermarkDateTimePicker : DateTimePicker
  {
    #region Properties
    ...
    /// </summary>
    public static readonly DependencyProperty ForceWatermarkProperty = DependencyProperty.Register( nameof(ForceWatermark), typeof( bool ), typeof( WatermarkDateTimePicker ), new UIPropertyMetadata( false, OnWatermarkPropertyChanged ) );
    ...
    /// </summary>
    public static readonly DependencyProperty HideOnFocusProperty = DependencyProperty.Register( nameof(HideOnFocus), typeof( bool ), typeof( WatermarkDateTimePicker ), new UIPropertyMetadata( true, OnWatermarkPropertyChanged ) );
    ...
    private static readonly DependencyPropertyKey IsWatermarkVisiblePropertyKey = DependencyProperty.RegisterReadOnly(
      ...
      typeof( bool ),
      typeof( WatermarkDateTimePicker ),
      new( false ) );

    /// <summary>
    /// Gets a value indicating whether the watermark is currently visible.
    /// This property is automatically updated based on Value, ForceWatermark, HideOnFocus, and focus state.
    /// </summary>
    ...
    /// <summary>
    /// Static constructor to override the default style key for WatermarkDateTimePicker.
    /// </summary>
    static WatermarkDateTimePicker()
    {
      DefaultStyleKeyProperty.OverrideMetadata( typeof( WatermarkDateTimePicker ), new FrameworkPropertyMetadata( typeof( WatermarkDateTimePicker ) ) );

      // Add property changed callback for Value property (inherited from base)
      ValueProperty.OverrideMetadata( typeof( WatermarkDateTimePicker ), new FrameworkPropertyMetadata( null, OnWatermarkPropertyChanged ) );
    }

    /// <summary>
    /// Instance constructor
    /// </summary>
    public WatermarkDateTimePicker()
    {
    ...
    {
      if( d is WatermarkDateTimePicker picker )
      {
    ...
    private void UpdateIsWatermarkVisible()
    {
      ...
      this.IsWatermarkVisible = shouldShowWatermark && focusAllowsWatermark;
    }
