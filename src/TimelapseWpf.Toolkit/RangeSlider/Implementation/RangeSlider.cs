...
namespace TimelapseWpf.Toolkit
{
  ...
  public class RangeSlider : Control
  {
    ...
    public static readonly DependencyProperty AutoToolTipPlacementProperty = DependencyProperty.Register( nameof(AutoToolTipPlacement), typeof( AutoToolTipPlacement ), typeof( RangeSlider ),
    ...
    public static readonly DependencyProperty AutoToolTipPrecisionProperty = DependencyProperty.Register( nameof(AutoToolTipPrecision), typeof( int ), typeof( RangeSlider ),
    ...
    public static readonly DependencyProperty HigherRangeBackgroundProperty = DependencyProperty.Register( nameof(HigherRangeBackground), typeof( Brush ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( Brushes.Transparent ) );

    public Brush HigherRangeBackground
    {
      get => (Brush)GetValue( RangeSlider.HigherRangeBackgroundProperty );
      set => SetValue( RangeSlider.HigherRangeBackgroundProperty, value );
    }
    ...
    public static readonly DependencyProperty HigherRangeStyleProperty = DependencyProperty.Register( nameof(HigherRangeStyle), typeof( Style ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( null ) );

    public Style HigherRangeStyle
    {
      get => (Style)this.GetValue( RangeSlider.HigherRangeStyleProperty );
      set => this.SetValue( RangeSlider.HigherRangeStyleProperty, value );
    }
    ...
    {
      get => (double)GetValue( RangeSlider.HigherRangeWidthProperty );
      private set => SetValue( RangeSlider.HigherRangeWidthPropertyKey, value );
    }
    ...
    {
      get => (Brush)GetValue( RangeSlider.HigherThumbBackgroundProperty );
      set => SetValue( RangeSlider.HigherThumbBackgroundProperty, value );
    }
    ...
    /// </summary>
    public static readonly DependencyProperty HigherValueProperty = DependencyProperty.Register( nameof(HigherValue), typeof( double ), typeof( RangeSlider )
    ...
    private static object OnCoerceHigherValueChanged( DependencyObject d, object basevalue )
    {
      ...
      var higherValue = Math.Max( rangeSlider.LowerValue, ( double)basevalue );
    ...
    /// </summary>
    public static readonly DependencyProperty IsDeferredUpdateValuesProperty = DependencyProperty.Register( nameof(IsDeferredUpdateValues), typeof( bool ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( false ) );

    public bool IsDeferredUpdateValues
    {
      get => (bool)GetValue( RangeSlider.IsDeferredUpdateValuesProperty );
      set => SetValue( RangeSlider.IsDeferredUpdateValuesProperty, value );
    }
    ...
    public static readonly DependencyProperty IsSnapToTickEnabledProperty = DependencyProperty.Register( nameof(IsSnapToTickEnabled), typeof( bool ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( false ) );

    public bool IsSnapToTickEnabled
    {
      get => (bool)GetValue( RangeSlider.IsSnapToTickEnabledProperty );
      set => SetValue( RangeSlider.IsSnapToTickEnabledProperty, value );
    }
    ...
    public static readonly DependencyProperty LowerRangeBackgroundProperty = DependencyProperty.Register( nameof(LowerRangeBackground), typeof( Brush ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( Brushes.Transparent ) );

    public Brush LowerRangeBackground
    {
      get => (Brush)GetValue( RangeSlider.LowerRangeBackgroundProperty );
      set => SetValue( RangeSlider.LowerRangeBackgroundProperty, value );
    }
    ...
    public static readonly DependencyProperty LowerRangeStyleProperty = DependencyProperty.Register( nameof(LowerRangeStyle), typeof( Style ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( null ) );

    public Style LowerRangeStyle
    {
      get => (Style)this.GetValue( RangeSlider.LowerRangeStyleProperty );
      set => this.SetValue( RangeSlider.LowerRangeStyleProperty, value );
    }
    ...
    {
      get => (double)GetValue( RangeSlider.LowerRangeWidthProperty );
      private set => SetValue( RangeSlider.LowerRangeWidthPropertyKey, value );
    }
    ...
    {
      get => (Brush)GetValue( RangeSlider.LowerThumbBackgroundProperty );
      set => SetValue( RangeSlider.LowerThumbBackgroundProperty, value );
    }
    ...
    private static object OnCoerceLowerValueChanged( DependencyObject d, object basevalue )
    {
      ...
      var lowerValue = Math.Min( (double)basevalue, rangeSlider.HigherValue );
    ...
    /// </summary>
    public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register( nameof(Orientation), typeof( Orientation ), typeof( RangeSlider ),
        new FrameworkPropertyMetadata( Orientation.Horizontal, RangeSlider.OnOrientationChanged ) );

    public Orientation Orientation
    {
      get => (Orientation)GetValue( RangeSlider.OrientationProperty );
      set => SetValue( RangeSlider.OrientationProperty, value );
    }
    ...
    public static readonly DependencyProperty RangeBackgroundProperty = DependencyProperty.Register( nameof(RangeBackground), typeof( Brush ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( Brushes.Transparent ) );

    public Brush RangeBackground
    {
      get => (Brush)GetValue( RangeSlider.RangeBackgroundProperty );
      set => SetValue( RangeSlider.RangeBackgroundProperty, value );
    }
    ...
    public static readonly DependencyProperty RangeStyleProperty = DependencyProperty.Register( nameof(RangeStyle), typeof( Style ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( null ) );

    public Style RangeStyle
    {
      get => (Style)this.GetValue( RangeSlider.RangeStyleProperty );
      set => this.SetValue( RangeSlider.RangeStyleProperty, value );
    }
    ...
    /// </summary>
    private static readonly DependencyProperty StepProperty = DependencyProperty.Register( nameof(Step), typeof( double ), typeof( RangeSlider )
      , new( 1.0, null, RangeSlider.CoerceStep ) );

    public double Step
    {
      get => (double)GetValue( RangeSlider.StepProperty );
      set => SetValue( RangeSlider.StepProperty, value );
    }
    ...
    /// </summary>
    public static readonly DependencyProperty TickFrequencyProperty = DependencyProperty.Register( nameof(TickFrequency), typeof( double ), typeof( RangeSlider )
      , new FrameworkPropertyMetadata( 1d, RangeSlider.OnTickFrequencyChanged ) );

    public double TickFrequency
    {
      get => (double)GetValue( RangeSlider.TickFrequencyProperty );
      set => SetValue( RangeSlider.TickFrequencyProperty, value );
    }
    ...
    {
      get => (TickPlacement)GetValue( RangeSlider.TickPlacementProperty );
      set => SetValue( RangeSlider.TickPlacementProperty, value );
    }
    ...
    public override void OnApplyTemplate()
    {
      ...
      if( _lowerRange != null )
      {
        _lowerRange.Click -= this.LowerRange_Click;
      }
      ...
      {
        _higherRange.Click -= this.HigherRange_Click;
      }
    ...
    private void SetSlidersMargins()
    {
      if( (_lowerSlider != null) && (_higherSlider != null) )
      {
        if( this.Orientation == Orientation.Horizontal )
        {
          ...
          _higherSlider.Margin = new( lowerSliderThumbWidth, 0d, 0d, 0d );
          _lowerSlider.Margin = new( 0d, 0d, higherSliderThumbWidth, 0d );
        }
        else
        {
          ...
          _higherSlider.Margin = new( 0d, 0d, 0d, lowerSliderThumbHeight );
          _lowerSlider.Margin = new( 0d, higherSliderThumbHeight, 0d, 0d );
        }
      }
    }
    ...
    private void UpdateHigherValue( double? value )
    {
      ...
      double newValue = Math.Max( cv.Minimum, Math.Min( cv.Maximum, value ?? 0d ) );
    ...
    {
      if( _lowerSlider is { IsLoaded: true } )
      {
    ...
    {
      if( _higherSlider is { IsLoaded: true } )
      {
        if( !this.IsDeferredUpdateValues )
        {
