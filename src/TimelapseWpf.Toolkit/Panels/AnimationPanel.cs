...
namespace TimelapseWpf.Toolkit.Panels
{
  public abstract class AnimationPanel : PanelBase
  {
    ...
    protected AnimationPanel()
    {
      ...
      FieldInfo[] fields = derivedType.GetFields(BindingFlags.Static | BindingFlags.NonPublic |
                                                 BindingFlags.Public);
      ...
      foreach (FieldInfo field in fields)
      {
        if (field.FieldType == typeof(DependencyProperty))
        {
          ...
          if (prop != null)
          {
            ...
            if (metaData is FrameworkPropertyMetadata frameworkData)
            {
    ...
    public static readonly DependencyProperty DefaultAnimationRateProperty =
      DependencyProperty.Register( nameof(DefaultAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( ( AnimationRate )1d ),
          AnimationPanel.ValidateDefaultAnimationRate );

    public AnimationRate DefaultAnimationRate
    {
      get => ( AnimationRate )this.GetValue( AnimationPanel.DefaultAnimationRateProperty );
      set => this.SetValue( AnimationPanel.DefaultAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty DefaultAnimatorProperty =
      DependencyProperty.Register( nameof(DefaultAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( Animators.Linear ),
          AnimationPanel.ValidateDefaultAnimator );

    public IterativeAnimator DefaultAnimator
    {
      get => ( IterativeAnimator )this.GetValue( AnimationPanel.DefaultAnimatorProperty );
      set => this.SetValue( AnimationPanel.DefaultAnimatorProperty, value );
    }
    ...
    public static readonly DependencyProperty EnterAnimationRateProperty =
      DependencyProperty.Register( nameof(EnterAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
    ...
    public AnimationRate EnterAnimationRate
    {
      ...
      set => this.SetValue( AnimationPanel.EnterAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty EnterAnimatorProperty =
      DependencyProperty.Register( nameof(EnterAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
    ...
    public IterativeAnimator EnterAnimator
    {
      ...
      set => this.SetValue( AnimationPanel.EnterAnimatorProperty, value );
    }
    ...
    public static readonly DependencyProperty ExitAnimationRateProperty =
      DependencyProperty.Register( nameof(ExitAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( AnimationRate.Default ) );

    public AnimationRate ExitAnimationRate
    {
      get => ( AnimationRate )this.GetValue( AnimationPanel.ExitAnimationRateProperty );
      set => this.SetValue( AnimationPanel.ExitAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty ExitAnimatorProperty =
      DependencyProperty.Register( nameof(ExitAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( IterativeAnimator.Default ) );

    public IterativeAnimator ExitAnimator
    {
      get => ( IterativeAnimator )this.GetValue( AnimationPanel.ExitAnimatorProperty );
      set => this.SetValue( AnimationPanel.ExitAnimatorProperty, value );
    }
    ...
    public static readonly DependencyProperty LayoutAnimationRateProperty =
      DependencyProperty.Register( nameof(LayoutAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( AnimationRate.Default ) );

    public AnimationRate LayoutAnimationRate
    {
      get => ( AnimationRate )this.GetValue( AnimationPanel.LayoutAnimationRateProperty );
      set => this.SetValue( AnimationPanel.LayoutAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty LayoutAnimatorProperty =
      DependencyProperty.Register( nameof(LayoutAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( IterativeAnimator.Default ) );

    public IterativeAnimator LayoutAnimator
    {
      get => ( IterativeAnimator )this.GetValue( AnimationPanel.LayoutAnimatorProperty );
      set => this.SetValue( AnimationPanel.LayoutAnimatorProperty, value );
    }
    ...
    public static readonly DependencyProperty SwitchAnimationRateProperty =
      DependencyProperty.Register( nameof(SwitchAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( AnimationRate.Default ) );

    public AnimationRate SwitchAnimationRate
    {
      get => ( AnimationRate )this.GetValue( AnimationPanel.SwitchAnimationRateProperty );
      set => this.SetValue( AnimationPanel.SwitchAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty SwitchAnimatorProperty =
      DependencyProperty.Register( nameof(SwitchAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( IterativeAnimator.Default ) );

    public IterativeAnimator SwitchAnimator
    {
      get => ( IterativeAnimator )this.GetValue( AnimationPanel.SwitchAnimatorProperty );
      set => this.SetValue( AnimationPanel.SwitchAnimatorProperty, value );
    }
    ...
    private static readonly DependencyPropertyKey SwitchParentPropertyKey =
      DependencyProperty.RegisterReadOnly( "SwitchParent", typeof( SwitchPanel ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( null,
          AnimationPanel.OnSwitchParentChanged ) );

    public static readonly DependencyProperty SwitchParentProperty = AnimationPanel.SwitchParentPropertyKey.DependencyProperty;

    public SwitchPanel SwitchParent => ( SwitchPanel )this.GetValue( AnimationPanel.SwitchParentProperty );
    ...
    public static readonly DependencyProperty SwitchTemplateProperty =
      DependencyProperty.Register( nameof(SwitchTemplate), typeof( DataTemplate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( null,
          AnimationPanel.OnSwitchTemplateChanged ) );

    public DataTemplate SwitchTemplate
    {
      get => ( DataTemplate )this.GetValue( AnimationPanel.SwitchTemplateProperty );
      set => this.SetValue( AnimationPanel.SwitchTemplateProperty, value );
    }
    ...
    public static readonly DependencyProperty TemplateAnimationRateProperty =
      DependencyProperty.Register( nameof(TemplateAnimationRate), typeof( AnimationRate ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( AnimationRate.Default ) );

    public AnimationRate TemplateAnimationRate
    {
      get => ( AnimationRate )this.GetValue( AnimationPanel.TemplateAnimationRateProperty );
      set => this.SetValue( AnimationPanel.TemplateAnimationRateProperty, value );
    }
    ...
    public static readonly DependencyProperty TemplateAnimatorProperty =
      DependencyProperty.Register( nameof(TemplateAnimator), typeof( IterativeAnimator ), typeof( AnimationPanel ),
        new FrameworkPropertyMetadata( IterativeAnimator.Default ) );

    public IterativeAnimator TemplateAnimator
    {
      get => ( IterativeAnimator )this.GetValue( AnimationPanel.TemplateAnimatorProperty );
      set => this.SetValue( AnimationPanel.TemplateAnimatorProperty, value );
    }
    ...
    public new Size DesiredSize => _switchParent?.DesiredSize ?? base.DesiredSize;
    ...
    {
      get => _switchParent?.RenderSize ?? base.RenderSize;
    ...
    protected internal new UIElementCollection InternalChildren => ( _switchParent == null ) ? base.InternalChildren : _switchParent.ChildrenInternal;

    #endregion

    #region VisualChildrenCount Protected Property

    protected override int VisualChildrenCount => this.HasLoaded ? this.InternalChildren.Count + this.ExitingChildren.Count : base.VisualChildrenCount;

    #endregion

    #region ChildrensParent Protected Property

    protected PanelBase ChildrensParent => _switchParent != null ? _switchParent : this;
    ...
    {
      get => _switchParent?.HasLoaded ?? _cacheBits[ ( int )CacheBits.HasLoaded ];
    ...
    private ItemsControl ItemsOwner => ItemsControl.GetItemsOwner( _switchParent == null ? this : _switchParent );
    ...
    {
      add => this.AddHandler( AnimationPanel.AnimationBegunEvent, value );
      remove => this.RemoveHandler( AnimationPanel.AnimationBegunEvent, value );
    }

    protected RoutedEventArgs RaiseAnimationBegunEvent()
    {
      return AnimationPanel.RaiseAnimationBegunEvent( ( this._switchParent != null ) ? this._switchParent : this );
    }
    ...
    {
      add => this.AddHandler( AnimationPanel.AnimationCompletedEvent, value );
      remove => this.RemoveHandler( AnimationPanel.AnimationCompletedEvent, value );
    }

    protected RoutedEventArgs RaiseAnimationCompletedEvent()
    {
      return AnimationPanel.RaiseAnimationCompletedEvent( ( this._switchParent != null ) ? this._switchParent : this );
    }
    ...
    {
      add => this.AddHandler( AnimationPanel.ChildEnteredEvent, value );
      remove => this.RemoveHandler( AnimationPanel.ChildEnteredEvent, value );
    }
    ...
    internal static ChildEnteredEventArgs RaiseChildEnteredEvent( UIElement target, UIElement child, Rect arrangeRect )
    {
      ...
      ChildEnteredEventArgs args = new( child, arrangeRect )
      {
    ...
    {
      add => this.AddHandler( AnimationPanel.ChildEnteringEvent, value );
      remove => this.RemoveHandler( AnimationPanel.ChildEnteringEvent, value );
    }
    ...
    private static ChildEnteringEventArgs RaiseChildEnteringEvent( UIElement target, UIElement child, Rect? EnterFrom, Rect ArrangeRect )
    {
      ...
      ChildEnteringEventArgs args = new( child, EnterFrom, ArrangeRect )
      {
    ...
    {
      add => this.AddHandler( AnimationPanel.ChildExitedEvent, value );
      remove => this.RemoveHandler( AnimationPanel.ChildExitedEvent, value );
    }
    ...
    private static ChildExitedEventArgs RaiseChildExitedEvent( UIElement target, UIElement child )
    {
      ...
      ChildExitedEventArgs args = new( child )
      {
    ...
    {
      add => this.AddHandler( AnimationPanel.ChildExitingEvent, value );
      remove => this.RemoveHandler( AnimationPanel.ChildExitingEvent, value );
    }
    ...
    private static ChildExitingEventArgs RaiseChildExitingEvent( UIElement target, UIElement child, Rect? exitTo, Rect arrangeRect )
    {
      ...
      ChildExitingEventArgs args = new( child, exitTo, arrangeRect )
      {
    ...
    {
      add => this.AddHandler( AnimationPanel.SwitchLayoutActivatedEvent, value );
      remove => this.RemoveHandler( AnimationPanel.SwitchLayoutActivatedEvent, value );
    }
    ...
    {
      add => this.AddHandler( AnimationPanel.SwitchLayoutDeactivatedEvent, value );
      remove => this.RemoveHandler( AnimationPanel.SwitchLayoutDeactivatedEvent, value );
    }
    ...
    internal void BeginChildExit( UIElement child )
    {
      ...
      if( state != null )
      {
        ...
        {
          state.TargetPlacement = ceea.ExitTo ?? Rect.Empty;
    ...
    {
      bool isDone = true;
      ChildState state = new( currentRect );
      ...
      if( state.Animator != null && !state.TargetPlacement.IsEmpty )
      {
        ...
        state.CurrentPlacement = state.Animator.GetInitialChildPlacement( grandchild, state.CurrentPlacement, state.TargetPlacement, this, ref rate, out var placementArgs, out isDone );
    ...
    internal static UIElement FindAncestorChildOfAnimationPanel( DependencyObject element, out AnimationPanel panel )
    {
      ...
      {
        panel = ( parent is SwitchPanel switchPanel )
            ? switchPanel._currentLayoutPanel
      ...
      UIElement parent)
    {
      ...
      foreach (KeyValuePair<string, FrameworkElement> entry in presenter._knownIDs)
      {
        ...
        if (ancestor is Visual parentVisual)
        {
          GeneralTransform transform = entry.Value.TransformToAncestor(parentVisual);
          if (transform is MatrixTransform matrixTransform)
          {
            ...
            matrixTransform.Matrix.Transform(points);
            result[entry.Key] = new(points[0], points[1]);
          }
        }
      }
    ...
    internal Size ArrangeChildrenCore(UIElementCollection children, Size finalSize)
    {
      ...
      try
      {
        ...
        if (this.IsSwitchInProgress && _switchParent != null)
        {
    ...
    protected override void OnVisualChildrenChanged( DependencyObject visualAdded, DependencyObject visualRemoved )
    {
      ...
      {
        if( visualRemoved is UIElement element )
        {
          this.IsRemovingInternalChild = true;
          try
          {
            this.BeginChildExit( element );
          }
          finally
          {
      ...
      if( _switchParent == null )
      {
        ...
        {
          this.OnNotifyVisualChildAdded( added );
        }
        else if( visualRemoved is UIElement element )
        {
          this.OnNotifyVisualChildRemoved( element );
        }
    ...
    private bool BeginChildAnimation( UIElement child, Rect placementRect )
    {
      ...
      ChildState state = this.EnsureChildState( child, placementRect );
      ...
      if( !state.HasExitCompleted )
      {
        ...
        if( state.Animator != null && !state.TargetPlacement.IsEmpty )
        {
          ...
          state.CurrentPlacement = state.Animator.GetInitialChildPlacement(
              ...
              ref rate, out var placementArgs, out isDone );
          state.AnimationRate = rate;
          state.PlacementArgs = placementArgs;
        }
        state.IsAnimating = !isDone;
    ...
    private ChildState EnsureChildState( UIElement child, Rect placementRect )
    {
      ChildState state = AnimationPanel.GetChildState( child );
      if( state == null )
      {
    ...
    {
      AnimationRate result = _switchParent?.DefaultAnimationRate ?? this.DefaultAnimationRate;
    ...
    {
      IterativeAnimator result = (_switchParent == null) ? this.DefaultAnimator :
    _switchParent.DefaultAnimator;
      switch (animationType)
      {
        case AnimationType.Enter:
          if (this.EnterAnimator != IterativeAnimator.Default || (_switchParent != null &&
    _switchParent.EnterAnimator != IterativeAnimator.Default))
          {
            if (EnterAnimator == IterativeAnimator.Default && _switchParent != null)
            {
              result = _switchParent.EnterAnimator;
            }
            else
            {
              result = EnterAnimator;
            }
          }
          break;

        case AnimationType.Exit:
          if (this.ExitAnimator != IterativeAnimator.Default || (_switchParent != null &&
    _switchParent.ExitAnimator != IterativeAnimator.Default))
          {
            if (ExitAnimator == IterativeAnimator.Default && _switchParent != null)
            {
              result = _switchParent.ExitAnimator;
            }
            else
            {
              result = ExitAnimator;
        ...
        case AnimationType.Layout:
          if (this.LayoutAnimator != IterativeAnimator.Default || (_switchParent != null &&
    _switchParent.LayoutAnimator != IterativeAnimator.Default))
          {
            if (LayoutAnimator == IterativeAnimator.Default && _switchParent != null)
            {
              result = _switchParent.LayoutAnimator;
            }
            else
            {
              result = LayoutAnimator;
            }
          }
          break;

        case AnimationType.Switch:
          if (_switchParent is { AreLayoutSwitchesAnimated: false })
          {
            result = null;
            Debug.WriteLine("AnimationPanel.cs::GetEffectiveAnimator - result is null (Switch case:AreLayoutSwitchesAnimated is false)");
          }
          else if (_switchParent != null)
          {
            if (this.SwitchAnimator != IterativeAnimator.Default || _switchParent.SwitchAnimator !=
    IterativeAnimator.Default)
            {
              result = (SwitchAnimator == IterativeAnimator.Default) ? _switchParent.SwitchAnimator :
    SwitchAnimator;
            }
          }
          break;
        ...
        case AnimationType.Template:
          if (this.TemplateAnimator != IterativeAnimator.Default || (_switchParent != null &&
    _switchParent.TemplateAnimator != IterativeAnimator.Default))
          {
            if (TemplateAnimator == IterativeAnimator.Default && _switchParent != null)
            {
              result = _switchParent.TemplateAnimator;
            }
            else
            {
              result = TemplateAnimator;
            }
          }
          break;
      }
      ...
      if (result == null)
      {
        Debug.WriteLine("AnimationPanel.cs::GetEffectiveAnimator - result is null (animationType: " + animationType + ")");
      }
          ...
          if( state != null )
          {
            ...
            if( state.IsAnimating )
            {
              state.CurrentPlacement = state.Animator.GetNextChildPlacement( child, t, state.CurrentPlacement,
                  state.TargetPlacement, this, state.AnimationRate, ref state.PlacementArgs, out var isDone );
              state.IsAnimating = !isDone;
              this.UpdateTrueArrange( child, state );
              if( !state.IsAnimating )
              {
    ...
    private void UpdateExitingChildren()
    {
      if( this.ExitingChildren.Count > 0 )
      {
        List<UIElement> exitingChildren = [..ExitingChildren];
    ...
    private readonly Collection<FrameworkElement> _animatingGrandchildren = [];
    ...
    private sealed class ChildState(Rect currentRect)
    {
      ...
      public DateTime BeginTimeStamp = DateTime.Now;
      public IterativeAnimator Animator;
      public Rect CurrentPlacement = currentRect;
      public Rect TargetPlacement = currentRect;
