...
namespace TimelapseWpf.Toolkit.Primitives
{
  ...
  public class SelectAllSelector : Selector
  {
    ...
    public static readonly DependencyProperty IsSelectAllActiveProperty = DependencyProperty.Register( nameof(IsSelectAllActive), typeof( bool ), typeof( SelectAllSelector ), new UIPropertyMetadata( false, OnIsSelectAllActiveChanged ) );
    ...
    {
      if( o is SelectAllSelector selector )
    ...
    public static readonly DependencyProperty SelectAllContentProperty = DependencyProperty.Register( nameof(SelectAllContent), typeof( object ), typeof( SelectAllSelector ), new UIPropertyMetadata( "Select All" ) );
