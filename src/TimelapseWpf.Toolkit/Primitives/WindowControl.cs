...
namespace TimelapseWpf.Toolkit.Primitives
{
  ...
  {
    public static readonly ComponentResourceKey DefaultCloseButtonStyleKey = new( typeof( WindowControl ), "DefaultCloseButtonStyle" );
    ...
    public static readonly DependencyProperty CaptionProperty = DependencyProperty.Register( nameof(Caption), typeof( string ), typeof( WindowControl ), new UIPropertyMetadata( String.Empty ) );
    ...
    public static readonly DependencyProperty CaptionFontSizeProperty = DependencyProperty.Register( nameof(CaptionFontSize), typeof( double ), typeof( WindowControl ), new UIPropertyMetadata( 15d ) );
    ...
    public static readonly DependencyProperty CaptionForegroundProperty = DependencyProperty.Register( nameof(CaptionForeground), typeof( Brush ), typeof( WindowControl ), new UIPropertyMetadata( null ) );
    ...
    public static readonly DependencyProperty CaptionShadowBrushProperty = DependencyProperty.Register( nameof(CaptionShadowBrush), typeof( Brush ), typeof( WindowControl ), new UIPropertyMetadata( new SolidColorBrush( Color.FromArgb( 179, 255, 255, 255 ) ) ) );
    ...
    public static readonly DependencyProperty CaptionIconProperty = DependencyProperty.Register( nameof(CaptionIcon), typeof( ImageSource ), typeof( WindowControl ), new UIPropertyMetadata( null ) );
    ...
    public static readonly DependencyProperty CloseButtonStyleProperty = DependencyProperty.Register( nameof(CloseButtonStyle), typeof( Style ), typeof( WindowControl ), new UIPropertyMetadata( null ) );
    ...
    public static readonly DependencyProperty CloseButtonVisibilityProperty = DependencyProperty.Register( nameof(CloseButtonVisibility), typeof( Visibility ), typeof( WindowControl ), new( Visibility.Visible, null, OnCoerceCloseButtonVisibility ) );
    ...
    private static object OnCoerceCloseButtonVisibility( DependencyObject d, object basevalue )
    {
      ...
      if( d is not WindowControl windowControl )
        return basevalue;
    ...
    public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register( nameof(IsActive), typeof( bool ), typeof( WindowControl ), new UIPropertyMetadata( true, OnIsActiveChanged, OnCoerceIsActive ) );
    ...
    protected virtual void OnIsActiveChanged( bool oldValue, bool newValue )
    {
      if( newValue )
      {
        ...
        {
          this.RaiseEvent( new( ActivatedEvent, this ) );
        }
      }
    }
    ...
    public static readonly DependencyProperty LeftProperty = DependencyProperty.Register( nameof(Left), typeof( double ), typeof( WindowControl ), new( 0.0, OnLeftPropertyChanged, OnCoerceLeft ) );
    public double Left
    {
    ...
    public static readonly DependencyProperty TopProperty = DependencyProperty.Register( nameof(Top), typeof( double ), typeof( WindowControl ), new( 0.0, OnTopPropertyChanged, OnCoerceTop ) );
    public double Top
    {
    ...
    public static readonly DependencyProperty WindowBackgroundProperty = DependencyProperty.Register( nameof(WindowBackground), typeof( Brush ), typeof( WindowControl ), new( null ) );
    ...
    public static readonly DependencyProperty WindowBorderBrushProperty = DependencyProperty.Register( nameof(WindowBorderBrush), typeof( Brush ), typeof( WindowControl ), new( null ) );
    ...
    public static readonly DependencyProperty WindowBorderThicknessProperty = DependencyProperty.Register( nameof(WindowBorderThickness), typeof( Thickness ), typeof( WindowControl ), new( new Thickness( 0 ) ) );
    ...
    public static readonly DependencyProperty WindowInactiveBackgroundProperty = DependencyProperty.Register( nameof(WindowInactiveBackground), typeof( Brush ), typeof( WindowControl ), new( null ) );
    ...
    public static readonly DependencyProperty WindowOpacityProperty = DependencyProperty.Register( nameof(WindowOpacity), typeof( double ), typeof( WindowControl ), new( 1d ) );
    ...
    public static readonly DependencyProperty WindowStyleProperty = DependencyProperty.Register( nameof(WindowStyle), typeof( WindowStyle ), typeof( WindowControl ), new( WindowStyle.SingleBorderWindow, null, OnCoerceWindowStyle ) );
    ...
    public static readonly DependencyProperty WindowThicknessProperty = DependencyProperty.Register( nameof(WindowThickness), typeof( Thickness ), typeof( WindowControl ),
                                                                        new( new Thickness( SystemParameters.ResizeFrameVerticalBorderWidth - 3,
    ...
    public override void OnApplyTemplate()
    {
      ...
      {
        _headerThumb.PreviewMouseLeftButtonDown -= this.HeaderPreviewMouseLeftButtonDown;
        _headerThumb.PreviewMouseRightButtonDown -= this.HeaderPreviewMouseRightButtonDown;
      ...
      if( _icon != null )
      {
        _icon.MouseLeftButtonDown -= this.IconMouseLeftButtonDown;
      }
      ...
      {
        _windowToolboxCloseButton.Click -= this.Close;
      }
    ...
    {
      MouseButtonEventArgs args = new( Mouse.PrimaryDevice, 0, MouseButton.Right )
      {
    ...
    {
      DragDeltaEventArgs args = new( e.HorizontalChange, e.VerticalChange )
      {
    ...
    {
      this.RaiseEvent( new( CloseButtonClickedEvent, this ) );
    }
    ...
    {
      if( this.Template.FindName( PART_HeaderGrid, this ) is Grid headerGrid )
