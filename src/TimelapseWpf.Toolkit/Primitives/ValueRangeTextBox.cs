...
namespace TimelapseWpf.Toolkit.Primitives
{
  public class ValueRangeTextBox : AutoSelectTextBox
  {
    ...
    public static readonly DependencyProperty BeepOnErrorProperty =
        DependencyProperty.Register( nameof(BeepOnError), typeof( bool ), typeof( ValueRangeTextBox ), new UIPropertyMetadata( false ) );
    ...
    public static readonly DependencyProperty FormatProviderProperty =
        DependencyProperty.Register( nameof(FormatProvider), typeof( IFormatProvider ), typeof( ValueRangeTextBox ),
    ...
    public static readonly DependencyProperty MinValueProperty =
        DependencyProperty.Register( nameof(MinValue), typeof( object ), typeof( ValueRangeTextBox ),
    ...
    {
      if (sender is not ValueRangeTextBox valueRangeTextBox || !valueRangeTextBox.IsInitialized)
      ...
      if( value.GetType() != type )
        throw new ArgumentException( "The value is not of type " + type.Name + ".", nameof(value) );
    ...
    public static readonly DependencyProperty MaxValueProperty =
        DependencyProperty.Register( nameof(MaxValue), typeof( object ), typeof( ValueRangeTextBox ),
      new UIPropertyMetadata(
      null,
      null,
    ...
    public static readonly DependencyProperty NullValueProperty =
        DependencyProperty.Register( nameof(NullValue), typeof( object ), typeof( ValueRangeTextBox ),
      new UIPropertyMetadata(
      null,
    ...
    {
      if (sender is not ValueRangeTextBox valueRangeTextBox)
        return;
    ...
    public static readonly DependencyProperty ValueProperty =
        DependencyProperty.Register( nameof(Value), typeof( object ), typeof( ValueRangeTextBox ),
      new FrameworkPropertyMetadata(
      null,
    ...
    {
      if (sender is not ValueRangeTextBox valueRangeTextBox || valueRangeTextBox.IsForcingValue)
        return;
    ...
    public static readonly DependencyProperty ValueDataTypeProperty =
        DependencyProperty.Register( nameof(ValueDataType), typeof( Type ), typeof( ValueRangeTextBox ),
      new UIPropertyMetadata(
      null,
    ...
    private static object ValueDataTypeCoerceValueCallback(DependencyObject sender, object value)
    {
      ...
      {
        throw new ArgumentException("An error occured while trying to change the ValueDataType.",
          exception);
      }
    ...
    public bool HasValidationError => ( bool )this.GetValue( ValueRangeTextBox.HasValidationErrorProperty );
    ...
    public bool IsValueOutOfRange => ( bool )this.GetValue( ValueRangeTextBox.IsValueOutOfRangeProperty );
    ...
    internal string GetTextFromValue( object value )
    {
      ...
      QueryTextFromValueEventArgs e = new( value, text );
    ...
    {
      bool success = this.QueryValueFromTextCore( text, out var value );

      QueryValueFromTextEventArgs e = new( text, value )
      {
    ...
    protected virtual void ValidateValue( object value )
    {
      ...
      {
        NullableConverter nullableConverter = new( validatingType );
      ...
      if( ( value != DBNull.Value ) && ( value.GetType() != validatingType ) )
        throw new ArgumentException( "The value is not of type " + validatingType.Name + ".", nameof(value) );
    ...
    internal void StartIMEComposition()
    {
      ...
      m_imePreCompositionCachedTextInfo = new( this );
    }
    ...
    {
      if( this.GetActiveFormatProvider() is CultureInfo cultureInfo )
        return cultureInfo;
