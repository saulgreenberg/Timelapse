...
namespace TimelapseWpf.Toolkit.Primitives
{
  ...
  public class DateTimePickerBase : DateTimeUpDown
  {
    ...
    public static readonly DependencyProperty IsOpenProperty = DependencyProperty.Register( nameof(IsOpen), typeof( bool ), typeof( DateTimePickerBase ), new UIPropertyMetadata( false, OnIsOpenChanged ) );
    public bool IsOpen
    {
    ...
    public static readonly DependencyProperty ShowDropDownButtonProperty = DependencyProperty.Register( nameof(ShowDropDownButton), typeof( bool ), typeof( DateTimePickerBase ), new UIPropertyMetadata( true ) );
