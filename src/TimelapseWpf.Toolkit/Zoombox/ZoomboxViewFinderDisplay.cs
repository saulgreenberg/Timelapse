...
namespace TimelapseWpf.Toolkit.Zoombox
{
  public class ZoomboxViewFinderDisplay : FrameworkElement
  {
    ...
    public Brush Background
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.BackgroundProperty, value );
    }
    ...
    internal Rect ContentBounds
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.ContentBoundsPropertyKey, value );
    }
    ...
    public Brush ShadowBrush
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.ShadowBrushProperty, value );
    }
    ...
    public Brush ViewportBrush
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.ViewportBrushProperty, value );
    }
    ...
    public Pen ViewportPen
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.ViewportPenProperty, value );
    }
    ...
    public Rect ViewportRect
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.ViewportRectProperty, value );
    }
    ...
    internal VisualBrush VisualBrush
    {
      ...
      set => this.SetValue( ZoomboxViewFinderDisplay.VisualBrushPropertyKey, value );
    }
    ...
    protected override Size MeasureOverride( Size availableSize )
    {
      ...
      Size displayPanelSize = new( width, height );
      ...
      if( displayPanelSize.Width > availableSize.Width || displayPanelSize.Height > availableSize.Height )
      {
        ...
        displayPanelSize = new( displayPanelSize.Width * scale, displayPanelSize.Height * scale );
      }
    ...
    protected override void OnRender( DrawingContext dc )
    {
      ...
      if( this.ViewportRect.IntersectsWith( new( this.RenderSize ) ) )
      {
        // draw shadow rectangles over the non-viewport regions
        Rect r1 = new( new( 0, 0 ), new Size( this.RenderSize.Width, Math.Max( 0, this.ViewportRect.Top ) ) );
        Rect r2 = new( new( 0, this.ViewportRect.Top ), new Size( Math.Max( 0, this.ViewportRect.Left ), this.ViewportRect.Height ) );
        Rect r3 = new( new( this.ViewportRect.Right, this.ViewportRect.Top ), new Size( Math.Max( 0, this.RenderSize.Width - this.ViewportRect.Right ), this.ViewportRect.Height ) );
        Rect r4 = new( new( 0, this.ViewportRect.Bottom ), new Size( this.RenderSize.Width, Math.Max( 0, this.RenderSize.Height - this.ViewportRect.Bottom ) ) );
      ...
      else
      {
        ...
        dc.DrawRectangle( this.ShadowBrush, null, new( this.RenderSize ) );
      }
    }
  }
}
