...
{
  public sealed class ZoomboxViewStack(Zoombox zoombox) : Collection<ZoomboxView>, IWeakEventListener
  {
    ...
    private readonly WeakReference _zoomboxRef = new( zoombox );
    ...
    {
      if (!object.ReferenceEquals(_source, source))
      {
        this.MonitorSource(false);
        _source = source;
    ...
    {
      ZoomboxView view = item as ZoomboxView ?? ZoomboxViewConverter.Converter.ConvertFrom( item ) as ZoomboxView;
      if( view == null )
