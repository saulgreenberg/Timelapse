...
namespace TimelapseWpf.Toolkit
{
  public class Wizard : ItemsControl
  {
    ...
    public static readonly DependencyProperty BackButtonContentProperty = DependencyProperty.Register( nameof(BackButtonContent), typeof( object ), typeof( Wizard ), new UIPropertyMetadata( "< Back" ) );
    ...
    public static readonly DependencyProperty BackButtonVisibilityProperty = DependencyProperty.Register( nameof(BackButtonVisibility), typeof( Visibility ), typeof( Wizard ), new UIPropertyMetadata( Visibility.Visible ) );
    ...
    public static readonly DependencyProperty CanCancelProperty = DependencyProperty.Register( nameof(CanCancel), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    ...
    public static readonly DependencyProperty CancelButtonClosesWindowProperty = DependencyProperty.Register( nameof(CancelButtonClosesWindow), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    ...
    public static readonly DependencyProperty CancelButtonContentProperty = DependencyProperty.Register( nameof(CancelButtonContent), typeof( object ), typeof( Wizard ), new UIPropertyMetadata( "Cancel" ) );
    ...
    public static readonly DependencyProperty CancelButtonVisibilityProperty = DependencyProperty.Register( nameof(CancelButtonVisibility), typeof( Visibility ), typeof( Wizard ), new UIPropertyMetadata( Visibility.Visible ) );
    ...
    public static readonly DependencyProperty CanFinishProperty = DependencyProperty.Register( nameof(CanFinish), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( false ) );
    ...
    public static readonly DependencyProperty CanHelpProperty = DependencyProperty.Register( nameof(CanHelp), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    public bool CanHelp
    {
    ...
    public static readonly DependencyProperty CanSelectNextPageProperty = DependencyProperty.Register( nameof(CanSelectNextPage), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    ...
    public static readonly DependencyProperty CanSelectPreviousPageProperty = DependencyProperty.Register( nameof(CanSelectPreviousPage), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    ...
    public static readonly DependencyProperty CurrentPageProperty = DependencyProperty.Register( nameof(CurrentPage), typeof( WizardPage ), typeof( Wizard ), new UIPropertyMetadata( null, OnCurrentPageChanged ) );
    ...
    public static readonly DependencyProperty ExteriorPanelMinWidthProperty = DependencyProperty.Register( nameof(ExteriorPanelMinWidth), typeof( double ), typeof( Wizard ), new UIPropertyMetadata( 165.0 ) );
    ...
    public static readonly DependencyProperty FinishButtonClosesWindowProperty = DependencyProperty.Register( nameof(FinishButtonClosesWindow), typeof( bool ), typeof( Wizard ), new UIPropertyMetadata( true ) );
    ...
    public static readonly DependencyProperty FinishButtonContentProperty = DependencyProperty.Register( nameof(FinishButtonContent), typeof( object ), typeof( Wizard ), new UIPropertyMetadata( "Finish" ) );
    ...
    public static readonly DependencyProperty FinishButtonVisibilityProperty = DependencyProperty.Register( nameof(FinishButtonVisibility), typeof( Visibility ), typeof( Wizard ), new UIPropertyMetadata( Visibility.Collapsed ) );
    ...
    public static readonly DependencyProperty HelpButtonContentProperty = DependencyProperty.Register( nameof(HelpButtonContent), typeof( object ), typeof( Wizard ), new UIPropertyMetadata( "Help" ) );
    ...
    public static readonly DependencyProperty HelpButtonVisibilityProperty = DependencyProperty.Register( nameof(HelpButtonVisibility), typeof( Visibility ), typeof( Wizard ), new UIPropertyMetadata( Visibility.Visible ) );
    ...
    public static readonly DependencyProperty NextButtonContentProperty = DependencyProperty.Register( nameof(NextButtonContent), typeof( object ), typeof( Wizard ), new UIPropertyMetadata( "Next >" ) );
    ...
    public static readonly DependencyProperty NextButtonVisibilityProperty = DependencyProperty.Register( nameof(NextButtonVisibility), typeof( Visibility ), typeof( Wizard ), new UIPropertyMetadata( Visibility.Visible ) );
    ...
    public Wizard()
    {
      CommandBindings.Add( new( WizardCommands.Cancel, ExecuteCancelWizard, CanExecuteCancelWizard ) );
      CommandBindings.Add( new( WizardCommands.Finish, ExecuteFinishWizard, CanExecuteFinishWizard ) );
      CommandBindings.Add( new( WizardCommands.Help, ExecuteRequestHelp, CanExecuteRequestHelp ) );
      CommandBindings.Add( new( WizardCommands.NextPage, ExecuteSelectNextPage, CanExecuteSelectNextPage ) );
      CommandBindings.Add( new( WizardCommands.PreviousPage, ExecuteSelectPreviousPage, CanExecuteSelectPreviousPage ) );
    }
    ...
    private void CanExecuteCancelWizard( object sender, CanExecuteRoutedEventArgs e )
    {
      if( CurrentPage != null )
      {
        e.CanExecute = CurrentPage.CanCancel ?? CanCancel;
      }
    }
    ...
    private void CanExecuteFinishWizard( object sender, CanExecuteRoutedEventArgs e )
    {
      if( CurrentPage != null )
      {
        e.CanExecute = CurrentPage.CanFinish ?? CanFinish;
      }
    }
    ...
    private void CanExecuteRequestHelp( object sender, CanExecuteRoutedEventArgs e )
    {
      if( CurrentPage != null )
      {
        e.CanExecute = CurrentPage.CanHelp ?? CanHelp;
      }
    }
    ...
    {
      RoutedEventArgs newEventArgs = new( routedEvent, this );
