...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    if (!ShellExecuteExW(&sei))
    {
        ...
        MessageBoxW(nullptr, errorMsg, L"Timelapse View Only", MB_OK | MB_ICONERROR);
        return 1;
    }
