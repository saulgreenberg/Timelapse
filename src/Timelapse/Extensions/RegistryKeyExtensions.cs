...
namespace Timelapse.Extensions
{
    ...
    public static class RegistryKeyExtensions
    {
        ...
        extension(RegistryKey registryKey)
        {
            ...
            /// </summary>
            public bool GetBoolean(string subKeyPath, bool defaultValue)
            {
            ...
            /// </summary>
            public DateTime GetDateTime(string subKeyPath, DateTime defaultValue)
            {
            ...
            /// </summary>
            public TimeSpan GetTimeSpanAsSeconds(string subKeyPath, TimeSpan defaultValue)
            {
                string value = registryKey.GetString(subKeyPath);
                if (value == null)
                {
            ...
            /// </summary>
            public double GetDouble(string subKeyPath, double defaultValue)
            {
                string valueAsString = registryKey.GetString(subKeyPath);
                if (valueAsString != null)
                {
            ...
            /// </summary>
            public TEnum GetEnum<TEnum>(string subKeyPath, TEnum defaultValue) where TEnum : struct, IComparable, IConvertible, IFormattable
            {
                string valueAsString = registryKey.GetString(subKeyPath);
                try
                {
            ...
            /// </summary>
            public int GetInteger(string subKeyPath, int defaultValue)
            {
            ...
            /// </summary>
            public Rect GetRect(string subKeyPath, Rect defaultValue)
            {
            ...
            public Size GetSize(string subKeyPath, Size defaultValue)
            {
            ...
            /// </summary>
            public string GetString(string subKeyPath, string defaultValue)
            {
                string valueAsString = registryKey.GetString(subKeyPath);
                if (valueAsString == null)
                {
            ...
            /// </summary>
            public string GetString(string subKeyPath)
            {
                // Check the arguments for null 
            ...
            /// </summary>
            public RecencyOrderedList<string> GetRecencyOrderedList(string subKeyPath)
            {
                // Check the arguments for null 
                ThrowIf.IsNullArgument(registryKey, nameof(registryKey));

                RegistryKey subKey = registryKey.OpenSubKey(subKeyPath);
                RecencyOrderedList<string> values = new(Defaults.NumberOfMostRecentDatabasesToTrack);
        ...
        extension(RegistryKey registryKey)
        {
            ...
            /// </summary>
            public void Write(string subKeyPath, bool value)
            {
                try
                {
            ...
            /// </summary>
            public void Write(string subKeyPath, DateTime value)
            {
            ...
            /// </summary>
            public void Write(string subKeyPath, double value)
            {
                try
                {
            ...
            /// </summary>
            public void Write(string subKeyPath, RecencyOrderedList<string> values)
            {
            ...
            /// </summary>
            public void Write(string subKeyPath, int value)
            {
                // Check the arguments for null 
                ThrowIf.IsNullArgument(registryKey, nameof(registryKey));
                try
            ...
            /// </summary>
            public void Write(string subKeyPath, Rect value)
            {
                try
                {
                    registryKey.Write(subKeyPath, value.ToString(CultureInfo.InvariantCulture));
            ...
            /// </summary>
            public void Write(string subKeyPath, Size value)
            {
                try
                {
                    registryKey.Write(subKeyPath, value.ToString(CultureInfo.InvariantCulture));
            ...
            /// </summary>
            public void Write(string subKeyPath, string value)
            {
                // Check the arguments for null 
                ThrowIf.IsNullArgument(registryKey, nameof(registryKey));
                try
            ...
            /// </summary>
            public void Write(string subKeyPath, TimeSpan value)
            {
                // Check the arguments for null 
                ThrowIf.IsNullArgument(registryKey, nameof(registryKey));
                try
