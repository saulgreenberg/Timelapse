...
namespace Timelapse.Extensions
{
    ...
    public static class DataGridExtensions
    {
        ...
        /// </summary>
        public static void ScrollIntoViewLastRow(this DataGrid dataGrid)
        {
        ...
        /// </summary>
        public static void ScrollIntoViewFirstRow(this DataGrid dataGrid)
        {
            if (dataGrid is { Items.Count: > 0 })
            {
        ...
        public static void ScrollIntoViewRow(this DataGrid dataGrid, int rowIndex)
        {
