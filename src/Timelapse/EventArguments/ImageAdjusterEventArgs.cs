...
namespace Timelapse.EventArguments
{
    ...
    public class ImageAdjusterEventArgs(double brightness, int contrast, bool sharpen, bool detectEdges, bool mono, bool useGamma, float gammaValue, bool openExternalViewer, bool forceUpdate)
        : EventArgs
    {
