...
namespace TimelapseTemplateEditor
{
    public partial class TemplateEditorWindow
    {
            ...
            if (sender is MenuItem mi)
            {
                switch (mi.Name)
                {
                    ...
                    case "MenuItemMetadataGuide":
                        ProcessExecution.TryProcessStart(new Uri(prefix + "TimelapseMetadataGuide.pdf"));
                        break;
        ...
        private void MenuItemAbout_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                //TODO Uncomment this when this is put back in: this.State.MostRecentCheckForUpdates = about.MostRecentCheckForUpdate.Value;
            }
        }
        #endregion
    }
