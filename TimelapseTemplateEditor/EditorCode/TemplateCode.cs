...
namespace TimelapseTemplateEditor
{
    public partial class TemplateEditorWindow
    {
        ...
        private async Task<bool> TemplateInitializeFromDBFileAsync(string templateDatabaseFilePath)
        {
            ...
            userSettings.MostRecentTemplates.SetMostRecent(templateDatabaseFilePath);
        ...
        public void TemplateDoRemoveSelectedRow()
        {
            ...
            if (TemplateUI.TemplateDataGridControl.DataGridInstance.SelectedItem is DataRowView selectedRowView && selectedRowView.Row != null)
            {
                ...
                dataGridBeingUpdatedByCode = true;
                templateDatabase.RemoveControlFromDataTableAndDatabase(new ControlRow(selectedRowView.Row));
