...
namespace TimelapseTemplateEditor.ControlsMetadata
{
    ...
    public partial class MetadataEntryPreviewPanel
    {
            ...
            foreach (MetadataControlRow control in metadataTable)
            {
                ...
                switch (control.Type)
                {
                    ...
                    case Control.Note:
                        ...
                        TextBox noteContent = PreviewControlCommon.CreateTextBox(styleProvider, control, ControlTypeEnum.MetadataControl);
                    ...
                    case Control.AlphaNumeric:
                        ...
                        TextBox alphanumericContent = PreviewControlCommon.CreateTextBox(styleProvider, control, ControlTypeEnum.MetadataControl);
                    ...
                    case Control.MultiLine:
                        ...
                        MultiLineTextEditor multiLineContent = PreviewControlCommon.CreateMultiLine(styleProvider, control, ControlTypeEnum.MetadataControl);
                    ...
                    case Control.IntegerAny:
                        ...
                        integerContent.GotFocus += ControlsDataHelpersCommon.Control_GotFocus; 
                        integerContent.LostFocus += ControlsDataHelpersCommon.Control_LostFocus;
                        break;
                    ...
                    case Control.DecimalPositive:
                        ...
                        decimalContent.GotFocus += ControlsDataHelpersCommon.Control_GotFocus; 
                        decimalContent.LostFocus += ControlsDataHelpersCommon.Control_LostFocus;
                        break;
                    ...
                    case Control.MultiChoice:
                        ...
                        CheckComboBox multiChoiceContent = PreviewControlCommon.CreateMultiChoiceComboBox(styleProvider, control, ControlTypeEnum.MetadataControl);
                        multiChoiceContent.PreviewKeyDown += Timelapse.Util.ValidationCallbacks.PreviewKeyDown_HandleKeyDownForEnter;
                        multiChoiceContent.Opened += ControlsDataHelpersCommon.CheckComboBox_DropDownOpened;
                        multiChoiceContent.Closed += ControlsDataHelpersCommon.CheckComboBox_DropDownClosed;
                        multiChoiceContent.ItemSelectionChanged += ControlsDataHelpersCommon.MultiChoice_ItemSelectionChanged;
                    ...
                    case Control.DateTime_:
                        ...
                        DateTimePicker dateTimeCustomContent = CreateControls.CreateDateTimePicker(control, DateTimeFormatEnum.DateAndTime,
                    ...
                    case Control.Date_:
                        ...
                        DateTimePicker dateContent = CreateControls.CreateDateTimePicker(control, DateTimeFormatEnum.DateOnly,
                    ...
                    case Control.Time_:
                        ...
                        TimePicker timeContent = CreateControls.CreateTimePicker(control,
        ...
        //private DateTimePicker CreateDateTimePicker(MetadataControlRow control)
        //{
        //    DateTimePicker dateTimePicker = new DateTimePicker
        //    {
        //        ToolTip = control.Tooltip,
        //        Width = ControlDefault.DateTimeCustomDefaultWidth, //control.Width,
        //        Height = 26,
        //        CultureInfo = CultureInfo.CreateSpecificCulture("en-US")
        //    };
        //    DataEntryHandler.Configure(dateTimePicker, ControlDefault.DateTimeCustomDefaultValue);
        //    dateTimePicker.GotFocus += Control_GotFocus;
        //    dateTimePicker.LostFocus += Control_LostFocus;
        //    return dateTimePicker;
        //}

        //private DateTimePicker CreateDatePicker(MetadataControlRow control)
        //{
        ...
        //        FormatString = Timelapse.Constant.Time_.DateDisplayFormat,
        //        TimePickerVisibility = Visibility.Collapsed,
        //        Value = ControlDefault.Date_DefaultValue,
        //    };

        //    //DataEntryHandler.Configure(datePicker, ControlDefault.DateTimeCustomDefaultValue);
        //    datePicker.GotFocus += Control_GotFocus;
        //    datePicker.LostFocus += Control_LostFocus;
        //    return datePicker;
        //}
        //private TimePicker CreateTimePicker(MetadataControlRow control)
        //{
        ...
        //        CultureInfo = CultureInfo.CreateSpecificCulture("en-US"),
        //        Format = DateTimeFormat.Custom,
        //        FormatString = Timelapse.Constant.Time_.TimeFormat,
        //        Value = ControlDefault.Time_DefaultValue,
        ...
        // Create Flag
        //private CheckBox CreateFlag(DataEntryControls styleProvider, CommonControlRow control)
        //{
        ...
        private void Control_GotFocus(object sender, RoutedEventArgs _)
        {
        ...
        private void Control_LostFocus(object sender, RoutedEventArgs _)
        {
            if (sender is System.Windows.Controls.Control control)
            {
        ...
        private void ControlsPanel_PreviewMouseMove(object sender, MouseEventArgs e)
        {
            if (Globals.MouseState.isMouseDown && e.Source is Label)
            {
                ...
                {
                    // Ignore drag/drop operations if it occurs over an open multiLineTextEditor.
                    // Otherwise one can't do any mouse move interactions with that editor e.g,
                    // selecting its text.
                    if (e.Source is MultiLineTextEditor multiLineTextEditor &&
                        multiLineTextEditor.IsOpen)
                    {
                        return;
                    }
        ...
        {
            if (!(Globals.MouseState.realMouseDragSource is Grid))
            {
