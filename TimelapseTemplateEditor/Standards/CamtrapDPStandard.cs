...
namespace TimelapseTemplateEditor.Standards
{
    public static class CamtrapDPStandard
    {
        ...
        public static List<StandardsRow> FolderMetadataRows = new List<StandardsRow>
        {
            ...
            new StandardsRow(
                Control.Note, 1, "", "Project ID*", "projectId",
                $"Unique identifier of the project.{Environment.NewLine}" +
                "• e.g., \"Project1\"",
                null),

            new StandardsRow(
                Control.Note, 1, "", "Title*", "title",
                $"Title of the project.{Environment.NewLine}" +
                "• e.g., \"CamtrapDP test project\"",
                null),

            new StandardsRow(
                Control.Note, 1, "", "Acronym*", "acronym",
                $"Acronym for this project.{Environment.NewLine}" +
                "• e.g., \"CamtrapDPTest\"",
                null),
            ...
            new StandardsRow(
                ...
                "• e.g., \"A test project to explore the CamtrapDP specifications in Timelapse.\"",
                null),

            new StandardsRow(
                Control.MultiLine, 1, "", "Path*", "path",
                $"Project website.{Environment.NewLine}" +
                "• e.g., \"https://saul.cpsc.ucalgary.ca/timelapse/.\"",
                null),

            new StandardsRow(
                Control.FixedChoice, 1, "", "Sampling Design*", "samplingDesign",
            ...
            new StandardsRow(
                Control.MultiChoice, 1, "", "Capture Method*", "captureMethod",
            ...
            new StandardsRow(
                Control.Flag, 1, "", "Individual Animals*", "individualAnimals",
                $"true if the project includes marked or recognizable individuals.{Environment.NewLine}" +
                "• e.g., \"false\"",
                null),

            new StandardsRow(
                Control.FixedChoice, 1, "", "Observation Level*", "observationLwevel",
