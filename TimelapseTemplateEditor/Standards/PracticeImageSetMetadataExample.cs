...
namespace TimelapseTemplateEditor.Standards
{
    public static class PracticeImageSetMetadataExample
    {
        ...
        public static List<string> SpeciesCommonList = new List<string>
        {
            "bear",
            "bighorn sheep",
            "bobcat",
        ...
        public static List<StandardsRow> FolderMetadataRows = new List<StandardsRow>
        {
            ...
            new StandardsRow(Control.MultiChoice, 3, "", "Trigger Mode(s)", "deployment_trig_modes",
                ...
                StandardsBase.CreateChoiceList(true, new List<string> {"Motion Image", "Time_-lapse Image", "Video", "Motion Image + Time_-lapse Image", "Motion Image + Time_-lapse Image + Video", "Time_-lapse Image + Video","Motion Image + Video"})),
        ...
        public static List<StandardsRow> ImageTemplateRows = new List<StandardsRow>
        {
            ...
            new StandardsRow(
                ...
                StandardsBase.CreateChoiceList(true, new List<string> {"wind triggered", "lens obscured", "malfunction", "misdirected", "snow or rain on lens",
