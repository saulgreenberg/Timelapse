    ...
    public partial class QuickPasteEditor
    {
        ...
        private void BuildRow(QuickPasteItem quickPasteItem, int gridRowIndex)
        {
            ...
            else if (quickPasteItem.ControlType == Control.MultiLine)
            {
                ...
                MultiLineText textBoxValue = new MultiLineText
                {
                    Text = quickPasteItem.Value,
                    Height = ValuesHeight,
                    Width = ValuesWidth,
            ...
            else if (quickPasteItem.ControlType == Control.DateTime_)
            {
                ...
                DateTimePicker dateTimePicker = DateTimeHandler.TryParseDatabaseOrDisplayDateTime(quickPasteItem.Value, out DateTime dateTime)
            ...
            else if (quickPasteItem.ControlType == Control.Date_)
            {
                ...
                DateTimePicker dateTimePicker = DateTimeHandler.TryParseDatabaseOrDisplayDate(quickPasteItem.Value, out DateTime date)
