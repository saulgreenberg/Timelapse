...
namespace Timelapse.Database
{
    ...
    public class SQLiteWrapper
    {
        ...
        public void UpsertRow(string tableName, ColumnTuple primaryKeyTuple, List<ColumnTuple> columnTuples)
        {
            ...
            names = names.Substring(0, names.Length - Sql.Comma.Length); // Remove the last comma
            values = values.Substring(0, values.Length - Sql.Comma.Length); // Remove the last comma
