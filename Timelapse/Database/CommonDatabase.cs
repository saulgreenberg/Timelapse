    ...
    public class CommonDatabase(string filePath) : IDisposable
    {
        ...
        public ControlRow AddControlToDataTableAndDatabase(string controlType)
        {
            ...
            switch (controlType)
            {
                ...
                case Control.MultiLine:
                    ...
                    newControl.DataLabel = GetNextUniqueDataLabelInControls(dataLabelPrefix);
                    newControl.Label = newControl.DataLabel;
                    //// TODO MULTILINE TOOLTIP UPDATE
                    //var dependencyProperty = System.ComponentModel.DependencyPropertyDescriptor.FromProperty(
                    //    Xceed.Wpf.Toolkit.MultiLineTextEditor.TextProperty,
                    //    typeof(Xceed.Wpf.Toolkit.MultiLineTextEditor));

                    //dependencyProperty?.AddValueChanged(controlType, (s, args) =>
                    //{
                    //    Globals.TemplateUI.TemplateDataGridControl.MultiLineTooltip_OnTextHasChanged(controlType, null);
                    //});
                    break;
        ...
        public void RemoveControlFromDataTableAndDatabase(ControlRow controlToRemove)
        {
            ...
            foreach (ControlRow control in Controls)
            {
                ...
                {
                    List<ColumnTuple> controlUpdate = [new ColumnTuple(Control.ControlOrder, controlOrder - 1)];
                ...
                {
                    List<ColumnTuple> controlUpdate = [new ColumnTuple(Control.SpreadsheetOrder, spreadsheetOrder - 1)];
        ...
        public void UpsertMetadataInfoTableRow(int level, string guid = null, string alias = null)
        {
            ...
            List<ColumnTuple> columnTuples = [new ColumnTuple(Control.Level, level)];
