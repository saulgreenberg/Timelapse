...
namespace Timelapse.ControlsMetadata
{
    public static class MetadataCreateControl
    {
        ...
        // Create Flag
        //public static CheckBox CreateFlag(DataEntryControls styleProvider, CommonControlRow control)
        //{
        ...
        public static CheckComboBox CreateMultiChoiceComboBox(DataEntryControls styleProvider, CommonControlRow control, ControlTypeEnum controlType)
        {
            ...
            // The displayed item should be the control's currentdefault value
            comboBox.SelectedItem = control.DefaultValue;
            return comboBox;
        }
        #endregion
