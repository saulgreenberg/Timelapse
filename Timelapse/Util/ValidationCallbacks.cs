...
namespace Timelapse.Util
{
    ...
    public static class ValidationCallbacks
    {
        ...
        {
            ControlsDataHelpersCommon.GenericControlHandleKeyDownForEnter(e);
        }
        #endregion
        ...
        public static void PreviewInput_AlphaNumericCharacterOnly(object sender, TextCompositionEventArgs args)
        {
            if (sender is TextBox textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleAlphanumericInputOnly(textBox, args, true);
            }
        }
        ...
        public static void PreviewInput_AlphaNumericCharacterOnlyWithGlob(object sender, TextCompositionEventArgs args)
        {
            if (sender is TextBox textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleAlphanumericWithGlobInputOnly(textBox, args, true);
            }
        }
        ...
        public static void TextChanged_AlphaNumericTextOnly(object sender, object _)
        {
            if (sender is TextBox textBox)
            {
                ...
                ControlsDataHelpersCommon.TextBoxHandleAlphanumericTextChange(window, textBox, true);
            }
        }
        public static void TextChanged_AlphaNumericTextWithGlobCharactersOnly(object sender, TextChangedEventArgs args)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleAlphanumericWithGlobTextChangedAlphanumericWithGlobTextChanged(window, textBox, true);
            }
        }
        #endregion
        ...
        public static void PreviewInput_IntegerCharacterOnly(object sender, TextCompositionEventArgs args)
        {
            ...
            if (null != textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleIntegerInputOnly(textBox, args, false, true);
            }
        }
        ...
        public static void PreviewInput_IntegerPositiveCharacterOnly(object sender, TextCompositionEventArgs args)
        {
            ...
            if (null != textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleIntegerInputOnly(textBox, args, true, true);
            }
        }
        ...
        public static void PreviewInput_DecimalCharacterOnly(object sender, TextCompositionEventArgs args)
        {
            ...
            if (null != textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleDecimalInputOnly(textBox, args, false, true);
            }
        }
        ...
        public static void PreviewInput_DecimalPositiveCharacterOnly(object sender, TextCompositionEventArgs args)
        {
            ...
            if (null != textBox)
            {
                ControlsDataHelpersCommon.TextBoxHandleDecimalInputOnly(textBox, args, true, true);
            }
        }
        ...
        public static void TextChanged_IntegerTextOnly(object sender, object _, bool positiveNumbersOnly)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleIntegerTextChanged(window, textBox, positiveNumbersOnly, true);
            }
        }
        ...
        public static void TextChanged_DecimalTextOnly(object sender, object _, bool positiveNumbersOnly)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleDecimalTextChanged(window, textBox, positiveNumbersOnly, true);
            }
        }
        #endregion
        ...
        public static void TextChanged_FixedChoiceTextOnly(object sender, object _, Choices choiceList)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleFixedChoiceTextChanged(window, textBox, choiceList, true);
            }
        }
        ...
        public static void TextChanged_MultiChoiceTextOnly(object sender, object _, Choices choiceList)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleMultiChoiceTextChanged(window, textBox, choiceList, true);
            }
        }
        ...
        public static void TextChanged_DateTimeTextOnly(object sender, object _, DateTimeFormatEnum dateTimeFormat)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleDateTimeTextChanged(window, textBox, dateTimeFormat, true);
            }
        }
        #endregion
        ...
        public static void TextChanged_BooleanTextOnly(object sender, object _)
        {
            ...
            {
                Window window = textBox.FindParentOfType<Window>();
                ControlsDataHelpersCommon.TextBoxHandleFlagTextChange(window, textBox, true);
            }
        }
        #endregion
        ...
        {
            ControlsDataHelpersCommon.Paste_OnlyIfAlphaNumeric(sender, args, false);
        }

        public static void Paste_OnlyIfCounter(object sender, DataObjectPastingEventArgs args)
        {
            ControlsDataHelpersCommon.Paste_OnlyIfNumber(sender, args, NumberTypeEnum.Counter);
        }

        public static void Paste_OnlyIfIntegerAny(object sender, DataObjectPastingEventArgs args)
        {
            ControlsDataHelpersCommon.Paste_OnlyIfNumber(sender, args, NumberTypeEnum.IntegerAny);
        }
        public static void Paste_OnlyIfIntegerPositive(object sender, DataObjectPastingEventArgs args)
        {
            ControlsDataHelpersCommon.Paste_OnlyIfNumber(sender, args, NumberTypeEnum.IntegerPositive);
        }
        public static void Paste_OnlyIfDecimalAny(object sender, DataObjectPastingEventArgs args)
        {
            ControlsDataHelpersCommon.Paste_OnlyIfNumber(sender, args, NumberTypeEnum.DecimalAny);
        }
        public static void Paste_OnlyIfDecimalPositive(object sender, DataObjectPastingEventArgs args)
        {
            ControlsDataHelpersCommon.Paste_OnlyIfNumber(sender, args, NumberTypeEnum.DecimalPositive);
        }
        #endregion
    }
}
