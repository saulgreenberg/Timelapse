...
namespace Timelapse.Images
{
    ...
    public static class ImageProcess
    {
        ...
        private static Bitmap AdjustGamma(SystemDrawingImage image, float gamma)
        {
            ...
            [
                new SystemDrawingPoint(0, 0),
                new SystemDrawingPoint(image.Width, 0),
                new SystemDrawingPoint(0, image.Height)
            ];
            SystemDrawingRectangle rect =
                new SystemDrawingRectangle(0, 0, image.Width, image.Height);
