...
namespace TimelapseTemplateEditor.Standards
{
    public static class CamtrapDPStandard
    {
        ...
        public static List<StandardsRow> FolderMetadataRows = new()
        {
            ...
            new StandardsRow(Control.DecimalAny, 2, "", "Latitude*", CamtrapDPConstants.Deployment.Latitude,
            ...
            new StandardsRow(Control.DecimalAny, 2, "", "Longitude*", CamtrapDPConstants.Deployment.Longitude,
            ...
            new StandardsRow(Control.IntegerPositive, 2, "", "Coordinate Uncertainty*", CamtrapDPConstants.Deployment.CoordinateUncertainty,
            ...
            new StandardsRow(Control.DateTime_, 2, "", "Deployment Start*", CamtrapDPConstants.Deployment.DeploymentStart,
                $"Date_ and time at which the deployment was started.{Environment.NewLine}" +
                $"Requried.{Environment.NewLine}" +
                "• e.g., \"2020-03-01T22:00:00Z\"",
                null),

            new StandardsRow(Control.DateTime_, 2, "", "Deployment End*", CamtrapDPConstants.Deployment.DeploymentEnd,
        ...
        [
            ...
            new StandardsRow(Control.DateTime_, 0, "", "Timestamp*", CamtrapDPConstants.Media.Timestamp,
            ...
            new StandardsRow(Control.FixedChoice, 0, "unclassified", "Observation type*", CamtrapDPConstants.Observations.ObservationType,
            ...
            new StandardsRow(Control.Counter, 0, "", "Count", CamtrapDPConstants.Observations.Count,
            ...
            new StandardsRow(Control.FixedChoice, 0, "", "Sex", CamtrapDPConstants.Observations.Sex,
            ...
            new StandardsRow(Control.Note, 0, "", "Behavior", CamtrapDPConstants.Observations.Behavior,
            ...
            new StandardsRow(Control.DecimalAny, 0, "", "Bbox X", CamtrapDPConstants.Observations.BboxX,
