...
namespace Timelapse
{
    ...
    public partial class TimelapseWindow
    {
        ...
        private bool TryGetTemplatePath(out string templateDatabasePath)
        {
            ...
            State.MostRecentImageSets.TryGetMostRecent(out string defaultTemplateDatabasePath);
        ...
        private async Task<Tuple<bool, string>> TryOpenTemplateAndBeginLoadFoldersAsync(string tdbDatabasePath, string fileDatabaseFilePath, bool checkForShortcuts = true)
        {
            ...
            TemplateSyncResults templateSyncResults = new TemplateSyncResults();
            ...
            DataHandler = new DataEntryHandler(fileDatabase);
            ...
            MetadataDataHandler = new MetadataDataEntryHandler(fileDatabase);
        ...
        private bool TryBeginImageFolderLoad(string imageSetFolderPath, string selectedFolderPath, bool isFirstTimeLoad)
        {
            ...
            if (levels > 0 && foldersWithImagesOrVideos.Count > 0)
            {
                ...
                if (divergentFolders.Count > 0)
                {
                    ...
                    Mouse.OverrideCursor = null;
                    MetadataFolderComplianceViewer dialog = new MetadataFolderComplianceViewer(this, DataHandler.FileDatabase, relativePathFolderList, DataHandler.FileDatabase.MetadataInfo);
            ...
            {
                Cursor cursor = Mouse.OverrideCursor;
                PopulateFieldsWithImageMetadataOnLoad populateField = new PopulateFieldsWithImageMetadataOnLoad(this, DataHandler.FileDatabase, filesToAdd[0].FullName);
            ...
            {
                ImageSetLoader loader = new ImageSetLoader(imageSetFolderPath, filesToAdd, DataHandler);
        ...
        private async Task OnFolderLoadingCompleteAsync(bool filesJustAdded)
        {
            ...
            if (false == string.IsNullOrEmpty(sortMessage))
            {
                ...
                ToastNotifier.ShowInformation(sortMessage, toastOptions);
            }
