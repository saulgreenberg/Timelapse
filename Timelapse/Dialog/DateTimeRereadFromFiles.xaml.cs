...
namespace Timelapse.Dialog
{
    public partial class DateTimeRereadFromFiles
    {
        ...
        private void DatagridFeedback_AutoGeneratedColumns(object sender, EventArgs e)
        {
            ...
            this.FeedbackGrid.Columns[1].Header = "Old date  \x2192  New Date_ if it differs";
        ...
        private async Task<ObservableCollection<DateTimeFeedbackTuple>> TaskRereadDatesAsync()
        {
            ...
            return await Task.Run(() =>
            {
                ...
                List<ImageRow> filesToAdjust = GetImageRowsWithChangedDates(this.Progress, count, feedbackRows, out int missingFiles);
            ...
            for (int fileIndex = 0; fileIndex < count; ++fileIndex)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        DateTimeAdjustmentEnum dateTimeAdjustment = file.TryReadDateTimeOriginalFromMetadata(this.fileDatabase.FolderPath);
                        if (dateTimeAdjustment == DateTimeAdjustmentEnum.MetadataNotUsed)
                        {
                            ...
                            file.SetDateTimeFromFileInfo(this.fileDatabase.FolderPath);
