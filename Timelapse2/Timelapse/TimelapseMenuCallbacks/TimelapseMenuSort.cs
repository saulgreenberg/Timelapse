...
namespace Timelapse
{
    ...
    public partial class TimelapseWindow
    {
        ...
        private string ShowSortFeedback(bool updateMenuChecks)
        {
            ...
            return this.StatusBar.SetSort(sortTerm[0].DataLabel, sortTerm[0].IsAscending == Constant.BooleanValue.True, sortTerm[1].DataLabel, sortTerm[1].IsAscending == Constant.BooleanValue.True);
        }
        #endregion
    }
}
