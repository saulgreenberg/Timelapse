...
namespace Timelapse.Database
{
    ...
    public static class MergeDatabasesNew
    {
            ...
            string pathPrefixFromRootToSourceDdb)
        {
            ...
            List<string> relativePathsInDdb =
                MergeDatabasesNew.GetDistinctRootsFromRelativePath(Ddb, pathPrefixFromRootToSourceDdb);
        ...
        private static List<string> GetDistinctRootsFromRelativePath(SQLiteWrapper ddb, string pathPrefix)
        {
            ...
            {
                string rootFolder = MergeDatabasesNew.GetRootFolder((string)row[0]);
